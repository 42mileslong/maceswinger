...
function gameloop() {
  ...
  if (p.state == "fight") {
    ...
    ctx.drawImage(healthbar,0,0,(Math.floor(curen.health/curen.healthmax*21)),2,Math.floor((size.w*.75-width/11*21)/2),0,Math.floor(width/11*curen.health/curen.healthmax*21),Math.floor(height/23*2));
